...
-- Main frame
local listFrame = CreateFrame("Frame", "MessageRadarListUI", UIParent, "ButtonFrameTemplate");
...
---START CHANGES
listFrame:SetResizeBounds(250, 340, 400, 449);
...
listFrame.portrait:SetTexture([[Interface\AddOns\MessageRadar\img\logo]]);
listFrame:Hide();
...
deleteButton:SetNormalTexture([[Interface\AddOns\MessageRadar\img\trash]]);
deleteButton:SetHighlightTexture([[Interface\AddOns\MessageRadar\img\trash]]);
...
addButton:SetNormalTexture([[Interface\AddOns\MessageRadar\img\iplus]]);
addButton:SetHighlightTexture([[Interface\AddOns\MessageRadar\img\iplus]]);
...
toggleButton:SetNormalTexture([[Interface\AddOns\MessageRadar\img\on]]);
toggleButton:SetHighlightTexture([[Interface\AddOns\MessageRadar\img\on]]);
...
local scrollFrame = CreateFrame("ScrollFrame", "MessageRadarListUIScroll", listFrame.Inset, "UIPanelScrollFrameTemplate2");
...
local function ToggleUpdate()
    if MessageRadar_settings.isActive then
        ...
        toggleButton:SetNormalTexture([[Interface\AddOns\MessageRadar\img\off]]);
        toggleButton:SetHighlightTexture([[Interface\AddOns\MessageRadar\img\off]]);
        listFrame.portrait:SetTexture([[Interface\AddOns\MessageRadar\img\logoo]]);
...
function _addon:FillList()
	...
	for i, search in ipairs(tkeys) do
        ...
        curdta = MessageRadar_data[search];
		curitm.searchString:SetText(search);
		
		if curdta.active then
			curitm.disb:SetNormalTexture([[Interface\AddOns\MessageRadar\img\on]]);
            curitm.disb:SetHighlightTexture([[Interface\AddOns\MessageRadar\img\on]]);
            curitm.disb:GetParent():SetBackdropColor(0.2,0.2,0.2,0.8);
            curitm.searchString:SetTextColor(1, 1, 1, 1);
		else
			curitm.disb:SetNormalTexture([[Interface\AddOns\MessageRadar\img\off]]);
            curitm.disb:SetHighlightTexture([[Interface\AddOns\MessageRadar\img\off]]);
