...
L["FIRST_START_MSG"] = "|cFF00FF00" .. _addonName .. "|r|cFFffb178: List UI can be opened with /mr or the button on the minimap. You can hide the button in settings.";
...
L["SETTINGS_MINIMAP_TT"] = "Show button for opening the list. Alternatively you can use /mr.";
...
L["SETTINGS_HEAD_CONFIG"] = "Configuration";
L["SETTINGS_EXPORT"] = "Export Configuration";
L["SETTINGS_EXPORT_TT"] = "Generate a string to share settings across characters or accounts.";
L["SETTINGS_IMPORT"] = "Import Configuration";
L["SETTINGS_IMPORT_TT"] = "Paste a configuration string to overwrite current settings.";

L["IMPORT_TITLE"] = "Import MessageRadar Config";
L["IMPORT_DESC"] = "|cffff0000WARNING:|r Importing will overwrite all current settings and keywords. Paste string and confirm:";
L["IMPORT_SUCCESS"] = "Configuration imported successfully! Reloading UI...";
L["IMPORT_ERROR"] = "Invalid configuration string, import failed.";
L["EXPORT_TITLE"] = "Export MessageRadar Config";
L["EXPORT_DESC"] = "Here is your configuration string. Press Ctrl+C to copy.";